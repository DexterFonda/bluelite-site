...
import { Users, ShoppingCart, Shield, Server, Copy } from "lucide-react";
...
export default function BlueLiteSite() {
  ...
  const NavBar = () => (
    <nav className="flex justify-center gap-6 p-4 bg-black border-b border-zinc-800">
  ...
  return (
    <div className="min-h-screen text-white bg-black">
      ...
      {/* SHOP */}
      {page === "shop" && (
        <section className="p-10 text-center bg-zinc-900">
